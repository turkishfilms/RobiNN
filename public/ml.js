...
let mouseXs = [500],
    ...
    width, height, error, alpha = 0.000001
...
function touchStarted() {
    ...
    mouseXs.push(msX)
    mouseYs.push(msY)
    console.log(linearRegressWeight.weights[0], linearRegressWeight.weights[1], error)
}
...
function draw() {
    ...
    const { ww, www } = gd({ iter: 1, w: [linearRegressWeight.weights[0], linearRegressWeight.weights[1]], xs: mouseXs, ys: mouseYs, alpha: alpha })
